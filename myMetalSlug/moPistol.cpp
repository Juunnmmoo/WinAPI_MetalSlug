...
namespace mo {
	...
	/*	player = GetPlayer();
		...
		mAnimator->CreateAnimation(L"P_KnifeR", mImageR, Vector2(120.0f * 0, 120.0f * 3), 120.0f, 30, 30, 6, Vector2::Zero, 0.07);
		mAnimator->CreateAnimation(L"P_KnifeL", mImageL, Vector2(120.0f * 29, 120.0f * 3), -120.0f, 30, 30, 6, Vector2::Zero, 0.07);
