...
//
//namespace mo {
//	Firegun::Firegun(Marco* marco, MarcoBottom* bottom)
...
//
//
//		mAnimator->CreateAnimation(L"F_KnifeR", mImageR, Vector2(120.0f * 0, 120.0f * 3), 120.0f, 30, 60, 6, Vector2::Zero, 0.07);
//		mAnimator->CreateAnimation(L"F_KnifeL", mImageL, Vector2(120.0f * 29, 120.0f * 3), -120.0f, 30, 60, 6, Vector2::Zero, 0.07);
//
...
//
//		mAnimator->CreateAnimation(L"F_ThrowingBombR", mImageR, Vector2(120.0f * 0, 120.0f * 12), 120.0f, 30, 60, 6, Vector2::Zero, 0.07);
//		mAnimator->CreateAnimation(L"F_ThrowingBombL", mImageL, Vector2(120.0f * 29, 120.0f * 12), -120.0f, 30, 60, 6, Vector2::Zero, 0.07);
//
//		mAnimator->CreateAnimation(L"F_ShootR_RT", mImageR, Vector2(120.0f * 0, 120.0f * 13), 120.0f, 30, 60, 2, Vector2::Zero, 0.07);
//		mAnimator->CreateAnimation(L"F_ShootR_TR", mImageR, Vector2(120.0f * 0, 120.0f * 14), 120.0f, 30, 60, 2, Vector2::Zero, 0.07);
//		mAnimator->CreateAnimation(L"F_ShootR_RB", mImageR, Vector2(120.0f * 0, 120.0f * 15), 120.0f, 30, 60, 2, Vector2::Zero, 0.07);
//		mAnimator->CreateAnimation(L"F_ShootR_BR", mImageR, Vector2(120.0f * 0, 120.0f * 16), 120.0f, 30, 60, 2, Vector2::Zero, 0.07);
//		mAnimator->CreateAnimation(L"F_ShootR_LT", mImageL, Vector2(120.0f * 29, 120.0f * 13), -120.0f, 30, 60, 2, Vector2::Zero, 0.07);
//		mAnimator->CreateAnimation(L"F_ShootR_TL", mImageL, Vector2(120.0f * 29, 120.0f * 14), -120.0f, 30, 60, 2, Vector2::Zero, 0.07);
//		mAnimator->CreateAnimation(L"F_ShootR_LB", mImageL, Vector2(120.0f * 29, 120.0f * 15), -120.0f, 30, 60, 2, Vector2::Zero, 0.07);
//		mAnimator->CreateAnimation(L"F_ShootR_BL", mImageL, Vector2(120.0f * 29, 120.0f * 16), -120.0f, 30, 60, 2, Vector2::Zero, 0.07);
//
//
//		mAnimator->GetStartEvent(L"F_ThrowingBombR") = std::bind(&Firegun::shootStartEvent, this);
//		mAnimator->GetStartEvent(L"F_ThrowingBombL") = std::bind(&Firegun::shootStartEvent, this);
//		mAnimator->GetStartEvent(L"F_KnifeR") = std::bind(&Firegun::shootStartEvent, this);
//		mAnimator->GetStartEvent(L"F_KnifeL") = std::bind(&Firegun::shootStartEvent, this);
//		mAnimator->GetStartEvent(L"F_ShootR") = std::bind(&Firegun::shootStartEvent, this);
//		mAnimator->GetStartEvent(L"F_ShootL") = std::bind(&Firegun::shootStartEvent, this);
//		mAnimator->GetStartEvent(L"F_ShootRT") = std::bind(&Firegun::shootStartEvent, this);
//		mAnimator->GetStartEvent(L"F_ShootLT") = std::bind(&Firegun::shootStartEvent, this);
//		mAnimator->GetStartEvent(L"F_ShootRB") = std::bind(&Firegun::shootStartEvent, this);
//		mAnimator->GetStartEvent(L"F_ShootLB") = std::bind(&Firegun::shootStartEvent, this);
//
//		mAnimator->GetCompleteEvent(L"F_ThrowingBombR") = std::bind(&Firegun::attackCompleteEvent, this);
//		mAnimator->GetCompleteEvent(L"F_ThrowingBombL") = std::bind(&Firegun::attackCompleteEvent, this);
//		mAnimator->GetCompleteEvent(L"F_KnifeR") = std::bind(&Firegun::attackCompleteEvent, this);
//		mAnimator->GetCompleteEvent(L"F_KnifeL") = std::bind(&Firegun::attackCompleteEvent, this);
//		mAnimator->GetCompleteEvent(L"F_ShootR") = std::bind(&Firegun::attackCompleteEvent, this);
//		mAnimator->GetCompleteEvent(L"F_ShootL") = std::bind(&Firegun::attackCompleteEvent, this);
//		mAnimator->GetCompleteEvent(L"F_ShootRT") = std::bind(&Firegun::attackCompleteEvent, this);
//		mAnimator->GetCompleteEvent(L"F_ShootLT") = std::bind(&Firegun::attackCompleteEvent, this);
//		mAnimator->GetCompleteEvent(L"F_ShootRB") = std::bind(&Firegun::attackCompleteEvent, this);
//		mAnimator->GetCompleteEvent(L"F_ShootLB") = std::bind(&Firegun::attackCompleteEvent, this);
//
//
//
...
//					mAnimator->Play(L"F_KnifeR", false);
//				else if (mDirection == eDirection::Left || mDirection == eDirection::LTop || mDirection == eDirection::LBottom)
//					mAnimator->Play(L"F_KnifeL", false);
//			}
//			else {
//				if (mDirection == eDirection::Right)
//					mAnimator->Play(L"F_ShootR", false);
//				else if (mDirection == eDirection::Left)
//					mAnimator->Play(L"F_ShootL", false);
//				else if (mDirection == eDirection::RTop)
//					mAnimator->Play(L"F_ShootRT", false);
//				else if (mDirection == eDirection::LTop)
//					mAnimator->Play(L"F_ShootLT", false);
//				else if (mDirection == eDirection::RBottom)
//					mAnimator->Play(L"F_ShootRB", false);
//				else if (mDirection == eDirection::LBottom)
//					mAnimator->Play(L"F_ShootLB", false);
//			}
//
//		}
//		if (Input::GetKeyDown(eKeyCode::F)) {
//			if (mDirection == eDirection::Right || mDirection == eDirection::RTop || mDirection == eDirection::RBottom)
//				mAnimator->Play(L"F_ThrowingBombR", false);
//			else if (mDirection == eDirection::Left || mDirection == eDirection::LTop || mDirection == eDirection::LBottom)
//				mAnimator->Play(L"F_ThrowingBombL", false);
//		}
//		if (Input::GetKey(eKeyCode::Left)
//			&& Camera::GetDistance().x < pos.x - 30.0f)
//		{
...
//	}
//
//	void Firegun::complete()
//	{
//	}
//
//	void Firegun::shootStartEvent()
//	{
//
//
//
...
//			if (activeAnimation->GetName() == L"F_ThrowingBombR" ||
//				activeAnimation->GetName() == L"F_ThrowingBombL" ||
//				isBomb)
//			{
//				isBomb = false;
...
//
//
//		if (prevAnimation->GetName() != L"F_ShootR" &&
//			prevAnimation->GetName() != L"F_ShootRT" &&
//			prevAnimation->GetName() != L"F_ShootL" &&
//			prevAnimation->GetName() != L"F_ShootLT" &&
//			prevAnimation->GetName() != L"F_ShootRB" &&
//			prevAnimation->GetName() != L"F_ShootLB" &&
//			prevAnimation->GetName() != L"F_KnifeR" &&
//			prevAnimation->GetName() != L"F_KnifeL" &&
//			prevAnimation->GetName() != L"F_ThrowingBombR" &&
//			prevAnimation->GetName() != L"F_ThrowingBombL")
//			mPrevAnimation = prevAnimation;
//
//	}
//
//
//	void Firegun::attackCompleteEvent()
//	{
//		isShooting = false;
//
